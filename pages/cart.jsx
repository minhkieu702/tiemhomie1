...
const cart = () => {
    ...
    return (
        <div>
            <BreadCrumb className="d-flex justify-content-center" href="/checkout" title="checkout" descriptionTitle="Giỏ hàng của bạn" />
                                                ...
                                                {products.map((product, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td className="product-name" data-title="Product">
                                                            <div className='m-1'>
                                                                <Link className={classes.name} href="detail">{product.name}</Link>
                                                            </div>
                                                            <div className='m-2'>
                                                                <h6>SKU: 290397</h6>
                                                            </div>
                                                    ...
                                                    <td colSpan={6} className="px-0 p-5">
                                                        <div className="row g-0 align-items-center">
                                                            <div className="col-lg-4 col-md-6 mb-3 mb-md-0 text-start">
                                                                <button className={`border-danger btn btn  btn-sm ${classes.btn}`} type="submit">Giỏ Hàng Trống</button>
                                                            </div>
                                    ...
                                    <div className="mt-4">
                                        <div className="heading_s1 mb-3">
                                            ...
                                            <div className='text-end'>
                                                <Link href="#" className={`border-danger btn btn-outline-light btn-sm ${classes.btn}`}>
                                                    Hoàn tất thanh toán
                                                </Link>
                                            </div>
                                        </div>
